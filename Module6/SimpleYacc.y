...
%token BEGIN END CYCLE ASSIGN SEMICOLON WHILE DO REPEAT UNTIL FOR TO LEFTBRACKET RIGHTBRACKET WRITE IF THEN ELSE VAR COMMA PLUS MINUS MULT DIV
%token <iVal> INUM 
%token <dVal> RNUM 
%token <sVal> ID
