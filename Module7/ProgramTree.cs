...
namespace ProgramTree
{
    ...
    public class IfNode : StatementNode
    {
        ...
        public StatementNode iStatement;
        public StatementNode eStatement;

        public IfNode(ExprNode exp, StatementNode st1, StatementNode st2)
        {
            expr = exp;
            iStatement = st1;
            eStatement = st2;
        ...
        public IfNode(ExprNode exp, StatementNode st1)
        {
            expr = exp;
            iStatement = st1;
            eStatement = new EmptyNode();
        }
