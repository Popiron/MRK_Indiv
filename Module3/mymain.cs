    ...
    class mymain
    {
        static void Main(string[] args)
        {
            ...
            do {
                ...
                if (tok == (int)Tok.EOF)
                {
                    cnt_id = scanner.LexIdCount;
                    min_id_len = scanner.LexMinIdLength;
                    avg_id_len = scanner.LexAvgIdLength / cnt_id;
                    max_id_len = scanner.LexMaxIdLength;
                    sum_int = scanner.LexSumInt;
                    sum_d = scanner.LexSumDouble;
